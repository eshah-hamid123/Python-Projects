...
class CafeForm(FlaskForm):
    ...
    URL = StringField('Cafe Location on Google Maps', validators=[DataRequired(), URL()])
...
def add_cafe():
    ...
    if form.validate_on_submit():
        with open('cafe-data.csv', 'a') as data_file:
            ...
            #data_file.write(f'{form.cafe.data},{form.URL.data},{form.open_time.data},{form.close_time.data},{form.coffee_rating.data}, {form.wifi_rating.data},{form.power_outlet_rating.data}\n')
